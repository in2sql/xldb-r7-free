...
## Pro  версия позволяет так же работать с MsSQL,  PostgreSQL, Oracle, MySQL, Trino. Использовать парметры для отчетов и управлять ими через менеджер .Так же доступно обновление данныех Первые 10 лицензий бесплатно.
  https://r7-consult.ru/
